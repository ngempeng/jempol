...
# USERNAME
rm -f /usr/bin/user
username=$(curl -sS https://raw.githubusercontent.com/ngempeng/jempol/master/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
# validity
rm -f /usr/bin/e
today=`date -d "0 days" +"%Y-%m-%d"`
valid=$(curl -sS https://raw.githubusercontent.com/ngempeng/jempol/master/izin | grep $MYIP | awk '{print $3}')
...
function first_setup(){
    ...
    echo deb "[signed-by=/usr/share/keyrings/haproxy.debian.net.gpg]" \
        http://haproxy.debian.net buster-backports-2.9 main \
...
function restart_system() {
    USRSC=$(curl -sS https://raw.githubusercontent.com/ngempeng/jempol/master/izin | grep $MYIP | awk '{print $2}')
    EXPSC=$(curl -sS https://raw.githubusercontent.com/ngempeng/jempol/master/izin | grep $MYIP | awk '{print $3}')
    DATEVPS=$(date +'%d/%m/%Y')
